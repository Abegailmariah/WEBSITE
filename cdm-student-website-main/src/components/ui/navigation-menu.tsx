...
export {
  // eslint-disable-next-line react-refresh/only-export-components -- navigationMenuTriggerStyle is intentionally co-located with NavigationMenu per shadcn/ui convention
