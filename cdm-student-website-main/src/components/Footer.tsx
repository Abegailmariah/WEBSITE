...
<div className="max-w-6xl mx-auto px-4 py-5 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <ul className="space-y-1.5">
            {quickLinks.map((item) => (
              <li key={item.to}>
                <Link
                  to={item.to}
                  className="text-xs text-secondary/90 hover:text-white transition-colors"
                >
                  {item.label}
                </Link>
              </li>
        ...
        <div>
          ...
          <ul className="space-y-2">
            {contactInfo.map((item) => (
              <li key={item.label} className="text-xs text-secondary/90">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-6xl mx-auto px-4 py-2.5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-secondary/80">
